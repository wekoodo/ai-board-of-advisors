...
|------------------------|-------------|
| Advisors, `_config/shared/`, setup, root chair/docs, examples, `profile/CONTEXT.md`, `profile/entities/CONTEXT.md`, `profile/entities/_template/` | Real profile data, your meetings, `_inbox/*` (except tracked README) |
