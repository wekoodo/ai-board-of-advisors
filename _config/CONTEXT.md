...
| `shared/board-process.md` | Board session flow and execution modes (manual / delegated) |
...
- `shared/board-process.md` is loaded by the board chair and session router when running a board session
