...
ones you confirm into `meetings/<meeting>/inputs/` (`<YYYY-MM-DD-HHMM>-<topic-slug>` or
`<scope>/<YYYY-MM-DD-HHMM>-<topic-slug>` — see `meetings/CONTEXT.md`). During in-depth entity
