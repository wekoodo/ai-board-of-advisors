# Session: example-2026-emergency-fund
Created: 2026-06-22
...
running the system end-to-end in delegated mode, not hand-authored, and demonstrates the simplest
path: one advisor, one round.
